  ...
  >
    <div class="container">
      <a href="index.php" class="navbar-brand" title="home">
        <img src="assets/images/hello.png" class="w-50" alt="logo" />
      </a>
      <button
  ...
  <div class="page-content page-cart">
                ...
                <?php foreach ($carts as $cart) : ?>
                  ...
                  <tr>
                    ...
                    <td style="width: 20%;">
                      ...
                      <div class="product-subtitle"><?= $cart["unit"]; ?> Pcs</div>
                    </td>
                    <td style="width: 10%;">
                    ...
                    <form action="" method="POST">
                      ...
                      <button type="submit" onclick="return confirm('Are you sure to remove this cart?')" name="deleteCart" class="btn btn-remove text-white btn-block px-3">Remove</button>
                    </form>
                    </td>
                  </tr>
                <?php endforeach;?>
        ...
        <form action="" method="POST">
          ...
          <div class="row mb-2" data-aos="fade-up" data-aos-delay="200">
            ...
            <div class="col-md-12 mt-2">
              <div class="form-group">
              <label for="rekening">Payment Option</label>
                  <?php 
            ...
            <?php if ($berat >= 10000) : ?>
              <div class="col-md-12 text-center my-4" id="alert-berat">
                <h5>The weight is over <strong>10 Kgs</strong></h5>
                <p class="text-muted">Do you want us to deliver your order?</p>
                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="radioTrue" value="1" name="delivered" class="custom-control-input">
                  <label class="custom-control-label" for="radioTrue">Yes, please</label>
                </div>
                <div class="custom-control custom-radio custom-control-inline">
                  <input type="radio" id="radioFalse" value="0" name="delivered" class="custom-control-input">
                  <label class="custom-control-label" for="radioFalse">No, thanks</label>
                </div>
              </div>
              <?php else : ?>
              <div class="col-md-12">
                <div class="form-group">
                  <label for="alamat">Fill your address and design:</label>
              ...
              <div class="col-md-12 mt-2" style="display: none;" id="alamat">
                <div class="form-group">
                  <label for="address">Fill your address and design:</label>
              ...
              <div class="col-md-12 text-center my-4" style="display: none;" id="bawa-sendiri">
                <h5 class="mb-2">We are based in :</h5>
          ...
          <div class="row justify-content-center" data-aos="fade-up" data-aos-delay="200">
            <div class="col-4 col-md-3">
              <div class="product-title"><?= number_format($banyak); ?> Pcs</div>
              <div class="product-subtitle mb-3">QTY</div>
            </div>
            <div class="col-4 col-md-3">
            ...
            <div class="col-8 col-md-3">
              ...
              <input type="hidden" name="weight" value="<?= $berat / 1000; ?>">
              <input type="hidden" name="total_price" value="<?= $total; ?>">
              <button type="submit" name="checkout" class="btn btn-info btn-block px-4 mt-1">Checkout Now</button>
            </div>
          </div>
        </form>
      </div>
    ...
    <footer>
      <div class=" container">
        <div class="row">
          <div class="col-12">
            <p class="pt-4 pb-2">HELLO Store | 2022</p>
          </div>
        </div>
      </div>
    </footer>
