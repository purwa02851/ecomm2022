...
<html lang="en">
  <head>
    ...
    <title>HELLO Store | Enjoy Your Day With Us</title>
      ...
      <section class="store-landing">
        <div class="container">
          <div class="row align-items-center justify-content-between">
            ...
            <div class="col-md-6">
                <h1 style="font-weight: bold; margin-bottom: 15px;">HELLO Store</h1>
                <p class="store-subtitle-landing" style="line-height: 28px; color: rgb(146, 146, 146);">
               
                </p>
              <a href="products.php" class="btn btn-info px-4 py-2 mt-4"
                  ...
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      <div class="adventege-description text-center text-lg-left">
                        <div class="title-text">Great Quality</div>
                        <div class="subtitle-text">
                            We print the design on high quality poster material with great technology    
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <div class="row justify-content-center align-content-center">
                    ...
                    <div class="col-md-8">
                      <div class="adventege-description text-center text-lg-left">
                        <div class="title-text">Great Delivery</div>
                        <div class="subtitle-text">
                            We deliver your order with our own drivers to make sure your stuff delivered to you
                        </div>
                      </div>
                    </div>
                  </div>
              ...
              <div class="card mb-4">
                <div class="card-body">
                  <div class="row justify-content-center align-content-center">
                    <div class="col-10 col-md-4">
                      <div class="adventeges-thumbnail mb-lg-0 mb-2">
                        <img src="assets/images/web-design.png" class="w-100" alt="" />
                      </div>
                    </div>
                    <div class="col-md-8">
                      <div
                      ...
                      >
                        <div class="title-text">Great Design</div>
                        <div class="subtitle-text">
                            All designs we have are created by the great graphics designers and illustrators
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div class="container">
          <div class="row">
            <div class="col-12" data-aos="fade-up">
              <h5 style="font-weight: 600; margin-bottom: 15px;">New Designs</h5>
            </div>
          </div>
          <div class="row">
            <?php 
              ...
              >
                ...
                <a href="details.php?id=<?= $idProduct; ?>" class="component-products d-block">
                  ...
                  <div class="d-flex justify-content-between align-items-center">
                    ...
                    <div>
                      <div class="text-muted"><?= $product["unit"]; ?> Unit</div>
                    </div>
                  </div>
                </a>
                <?php else : ?>
                <div class="component-products d-block">
                  <div class="products-thumbnail position-relative">
                      <div class="position-absolute d-flex justify-content-center align-items-center bg-dark" style="opacity: .7;">
