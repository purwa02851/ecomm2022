...
<html lang="en">
  <head>
    ...
    <title>HELLO Store | Details</title>
            ...
            <div class="row">
              <div class="col-lg-8 d-flex justify-content-between">
                <div>
                  ...
                  <div class="owner"><?= $product["unit"]; ?> Unit </div>
                ...
                <div>
                  <p>
                    Tersedia : <strong><?= $product["stock"]; ?> Unit</strong>
                  </p>
                </div>
              </div>
              ...
              <div class="col-lg-2" data-aos="zoom-in">
                  ...
                  <button type="submit" name="addToCart" class="btn btn-success px-4 text-white btn-block mb-3 py-2">
                    Add to cart
                  </button>
              </div>
              <?php endif; ?>
