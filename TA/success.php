...
<html lang="en">
  <head>
    ...
    <title>Trasaction success!</title>
        ...
        <div class="container">
          <div class="row align-items-center row-login justify-content-center">
            <div class="col-lg-6 text-center">
              ...
              <p>
                Please upload the transfer information to proof the transaction!
              </p>
              <div>
                <?php if ($user["roles"] == 'ADMIN') : ?>
                <a href="admin" class="btn btn-info w-50 mt-4">
                  My Dashboard
                </a>
                <?php else : ?>
                <a href="user" class="btn btn-info w-50 mt-4">
                  My Dashboard
                </a>
                <?php endif; ?>
