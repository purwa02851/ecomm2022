...
<html lang="en">
  <head>
    ...
    <title>HELLO Store | Login Driver</title>
      ...
      <section class="store-auth" data-aos="fade-up">
        <div class="container">
          <div class="row align-items-center row-login">
            <div class="col-lg-5">
              <h2 class="mb-4">Get up and deliver the order! Login</h2>
              <form action="" method="POST" class="mt-3">
                  <?php if (isset($error)) : ?>
                      <div class="alert alert-danger w-75">
                          <p class="font-weight-bold m-0">Sorry, Email / Username is incorrect</p>
                      </div>
                  <?php endif;?>
                ...
                <button type="submit" name="login" class="btn btn-success btn-block w-75 mt-4">Sign In to My Account</button>
                <a href="index.php" class="btn btn-login btn-block w-75 mt-2">Back To Home</a>
              </form>
            </div>
            <div class="col-lg-6 text-center">
              <img src="assets/images/delivery.jpg" alt="" class="w-50 mb-lg-none"/>
            </div>
          </div>
        </div>
      </section>
